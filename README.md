...
[Project Page](https://developer.wordpress.org/playground/) | [Live demo](https://wp-playground.khulnasoft.com/) | [Documentation and API Reference](https://wordpress.github.io/wordpress-playground/)

[WordPress Playground](https://github.com/khulnasoft-lab/wordpress-playground) is an experimental in-browser WordPress that runs without a PHP server thanks to the magic of WebAssembly.

![](https://raw.githubusercontent.com/khulnasoft-lab/wordpress-playground/trunk/demo.png)
...
Learn more about the [vision](https://github.com/khulnasoft-lab/wordpress-playground/issues/472) and the [roadmap](https://github.com/khulnasoft-lab/wordpress-playground/issues/525).
...
WordPress [Playground Tools](https://github.com/khulnasoft-lab/playground-tools) are independent applications built on top of WordPress Playground. They are located in a different repository: [WordPress/playground-tools](https://github.com/khulnasoft-lab/playground-tools).

These tools include:

-   [Interactive Code Block for Gutenberg](https://github.com/khulnasoft-lab/playground-tools/tree/trunk/packages/interactive-code-block/#readme)
-   [WordPress Playground for Visual Studio Code](https://github.com/khulnasoft-lab/playground-tools/tree/trunk/packages/vscode-extension/#readme)
-   [wp-now](https://github.com/khulnasoft-lab/playground-tools/tree/trunk/packages/wp-now/#readme) CLI local development environment.
...
[WordPress Playground](https://github.com/khulnasoft-lab/wordpress-playground) is a WordPress.org project started and maintained by [Adam Zielinski](https://github.com/adamziel). As Adam is on sabbatical until September 26th, [Dennis Snell](https://github.com/dmsnell) is the current maintainer.

[Playground tools](https://github.com/khulnasoft-lab/playground-tools) like `wp-now` or the interactive code block are maintained by their authors in the [playground-tools monorepo](https://github.com/khulnasoft-lab/playground-tools).
