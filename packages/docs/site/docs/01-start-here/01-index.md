...
-   [Start using WordPress Playground](../02-start-using/01-index.md) in 5 minutes (and check out the [demo site](https://wp-playground.khulnasoft.com/))
...
WordPress Playground is free software, and is released under the terms of the GNU General Public License version 2 or (at your option) any later version. See [LICENSE.md](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/LICENSE). for complete license.
