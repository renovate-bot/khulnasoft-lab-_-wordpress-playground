...
```html
<iframe src="https://wp-playground.khulnasoft.com/?plugin=coblocks"></iframe>
```
...
See the [live example of Gutenberg PR previewer](https://wp-playground.khulnasoft.com/gutenberg.html).
...
```html
<iframe src="https://wp-playground.khulnasoft.com/?php=7.4&wp=6.1"></iframe>
```
