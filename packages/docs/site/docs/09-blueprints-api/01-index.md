...
However, if you do have a development environment, that's great! You can use the [Blueprint JSON schema](https://wp-playground.khulnasoft.com/blueprint-schema.json) to get autocompletion and validation.
