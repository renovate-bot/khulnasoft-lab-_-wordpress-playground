...
The easiest way to start using Blueprints is to paste one into the URL "fragment" on WordPress Playground website, e.g. `https://wp-playground.khulnasoft.com/#{"preferredVersions...`.
...
`https://wp-playground.khulnasoft.com/#{"preferredVersions": {"php":"7.4", "wp":"5.9"}}`.
