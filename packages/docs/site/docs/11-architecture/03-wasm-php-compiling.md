...
The build pipeline lives in a [`Dockerfile`](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/src/packages/php-wasm/compile/Dockerfile). It was originally forked from [seanmorris/php-wasm](https://github.com/seanmorris/php-wasm)
...
To find out more about each step, refer directly to the [Dockerfile](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/src/packages/php-wasm/compile/Dockerfile).
...
PHP is built with several extensions listed in the [`Dockerfile`](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/src/packages/php-wasm/compile/Dockerfile).
...
The C API exposed to JavaScript lives in the [`php_wasm.c`](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/src/packages/php-wasm/compile/build-assets/php_wasm.c) file. The most important functions are:
...
Refer to the inline documentation in [`php_wasm.c`](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/src/packages/php-wasm/compile/build-assets/php_wasm.c) to learn more.
