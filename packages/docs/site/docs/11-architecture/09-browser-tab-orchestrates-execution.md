...
![The boot sequence](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/packages/docs/site/static/img/boot-sequence.png)
...
![The data flow](https://raw.githubusercontent.com/khulnasoft-lab/wordpress-playground/trunk/pages/data-flow.png)
