...
Unfortunately, the Service Worker cannot directly communicate with the relevant Worker Thread – see [PR #31](https://github.com/khulnasoft-lab/wordpress-playground/pull/31) and [issue #9](https://github.com/khulnasoft-lab/wordpress-playground/issues/9) for more details.
