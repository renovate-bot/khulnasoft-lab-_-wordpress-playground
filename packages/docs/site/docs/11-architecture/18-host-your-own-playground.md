...
You can host the Playground on your own domain instead of `wp-playground.khulnasoft.com`.
...
To host the Playground as is, without making changes, you can download the built artifact from [the latest successful GitHub Action](https://github.com/khulnasoft-lab/wordpress-playground/actions/workflows/build-website.yml?query=is%3Asuccess).

-   Click on **Deploy to wp-playground.khulnasoft.com**.
...
To customize the Playground, you can [fork the Git repository](https://github.com/khulnasoft-lab/wordpress-playground/fork).

Build it from the fork's GitHub page by going to: **Actions -> Deploy to wp-playground.khulnasoft.com -> Run workflow**.
...
-   [packages/playground/remote/public/.htaccess](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/packages/playground/remote/public/.htaccess)
-   [packages/playground/website/public/.htaccess](https://github.com/khulnasoft-lab/wordpress-playground/blob/trunk/packages/playground/website/public/.htaccess)
