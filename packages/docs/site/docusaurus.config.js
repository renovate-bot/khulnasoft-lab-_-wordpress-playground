		...
		[
			...
			({
				docs: {
					...
					editUrl:
						'https://github.com/khulnasoft-lab/wordpress-playground/tree/trunk/packages/docs/site/',
		...
		({
			...
			navbar: {
				...
				items: [
					...
					{
						href: 'https://wp-playground.khulnasoft.com/gutenberg.html',
						label: 'Gutenberg PR Previewer',
						position: 'right',
					},
					{
						href: 'https://github.com/khulnasoft-lab/wordpress-playground',
						label: 'GitHub',
						position: 'right',
					},
				],
