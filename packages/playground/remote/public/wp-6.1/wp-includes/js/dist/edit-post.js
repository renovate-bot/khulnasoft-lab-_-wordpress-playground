...
const initializeMetaBoxes = () => _ref16 => {
  ...
  registry.subscribe(async () => {
    ...
    //
    // See: https://github.com/khulnasoft-lab/WordPress/blob/5.1.1/wp-admin/includes/post.php#L2307-L2309.
...
function PostPublishButtonOrToggle(_ref) {
   ...
   *  	 See: https://github.com/khulnasoft-lab/gutenberg/issues/10475
   *
 ...
 * @param {...*}                  [props.other]                         Any additional props are passed through to the underlying [MenuItem](https://github.com/khulnasoft-lab/gutenberg/tree/HEAD/packages/components/src/menu-item/README.md) component.
 *
 * @example
 * ```js
 * // Using ES5 syntax
