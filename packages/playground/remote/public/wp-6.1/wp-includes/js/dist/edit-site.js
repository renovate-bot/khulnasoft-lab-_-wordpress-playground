...
function ActionItemSlot(_ref) {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Slot, {
    ...
    // @see https://github.com/khulnasoft-lab/gutenberg/issues/14457
...
function getStylesDeclarations() {
  ...
  const output = (0,external_lodash_namespaceObject.reduce)(external_wp_blocks_namespaceObject.__EXPERIMENTAL_STYLE_PROPERTY, (declarations, _ref5, key) => {
    ...
    // This may change: https://github.com/khulnasoft-lab/gutenberg/issues/40132.
...
const toStyles = function (tree, blockSelectors, hasBlockGapSupport, hasFallbackGapSupport) {
   ...
   * @link https://github.com/khulnasoft-lab/gutenberg/issues/36147.
   */
...
function ScreenBlockList() {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(() => {
    ...
    // which is now one.
    // @see https://github.com/khulnasoft-lab/gutenberg/pull/39117#discussion_r816022116
...
function SidebarComplementaryAreaFills() {
  ...
  // See https://github.com/khulnasoft-lab/gutenberg/blob/trunk/docs/how-to-guides/feature-flags.md#dead-code-elimination.
...
function NavigationToggle(_ref) {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(() => {
    ...
    // See: https://github.com/khulnasoft-lab/gutenberg/pull/37314
    if (!isNavigationOpen) {
...
function useTitle(title) {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(() => {
    ...
    if (title && siteTitle) {
      // @see https://github.com/khulnasoft-lab/wordpress-develop/blob/94849898192d271d533e09756007e176feb80697/src/wp-admin/admin-header.php#L67-L68
...
function reinitializeEditor(target, settings) {
   ...
   * https://github.com/khulnasoft-lab/gutenberg/pull/37157
   */
