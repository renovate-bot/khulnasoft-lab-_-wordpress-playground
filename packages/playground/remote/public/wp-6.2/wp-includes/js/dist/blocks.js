...
function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    if (serverSideBlockDefinitions[blockName]) {
      ...
      // @see https://github.com/khulnasoft-lab/gutenberg/pull/29279
      ...
      // @see https://github.com/khulnasoft-lab/gutenberg/pull/39894
 ...
 * source `node`.
 *
 * @see https://github.com/khulnasoft-lab/gutenberg/pull/10439
 *
...
function parseRawBlock(rawBlock, options) {
  ...
  const parsedInnerBlocks = normalizedBlock.innerBlocks.map(innerBlock => parseRawBlock(innerBlock, options)) // See https://github.com/khulnasoft-lab/gutenberg/pull/17164.
...
function segmentHTMLToShortcodeBlock(HTML) {
  ...
  if (match = (0,external_wp_shortcode_namespaceObject.next)(transformTag, HTML, lastIndex)) {
    ...
    if (typeof transformation.transform === 'function') {
      ...
      //
      // See: https://github.com/khulnasoft-lab/gutenberg/pull/3610#discussion_r152546926
...
function pasteHandler(_ref) {
  ...
  // See: https://github.com/khulnasoft-lab/gutenberg/pull/6983#pullrequestreview-125151075
