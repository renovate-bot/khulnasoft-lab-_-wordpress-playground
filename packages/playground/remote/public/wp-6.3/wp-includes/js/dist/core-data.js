...
// See https://github.com/khulnasoft-lab/gutenberg/pull/40025#discussion_r865410589 for more context.
 ...
 *
 * See https://github.com/khulnasoft-lab/gutenberg/pull/41578 for more details.
 */
 ...
 *
 * @see GetEntityRecord
 * @see https://github.com/khulnasoft-lab/gutenberg/pull/41578
 */
...
const resolvers_getEntityRecords = (kind, name, query = {}) => async ({
  ...
  try {
    ...
    // See https://github.com/khulnasoft-lab/gutenberg/pull/26575
...
function useEntityBlockEditor(kind, name, {
  ...
  const updateFootnotes = (0,external_wp_element_namespaceObject.useCallback)(_blocks => {
    ...
    // https://github.com/khulnasoft-lab/gutenberg/pull/43204 lands. We can then
